...
public class NMSManager {
    ...
    public static Class<?> getNMSClass(String ClassName) {
        Class<?> C = null;
        try { return Class.forName("net.minecraft.server." + "v1_19_R1" + "." + ClassName); } catch(Exception ignored) { }
        return C;
    }

    public static Class<?> getOBCClass(String ClassName) {
        Class<?> C = null;
        try { return Class.forName("org.bukkit.craftbukkit." + "v1_19_R1" + "." + ClassName); } catch(Exception ignored) { }
        return C;
    }
