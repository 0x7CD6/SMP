...
public class DiscordWebhook {
    ...
    public void addEmbed(EmbedObject embed) {embeds.add(embed);}

    public void execute() throws IOException {
        if (content == null && embeds.isEmpty()) throw new IllegalArgumentException("Set content or add at least one EmbedObject");
        ...
        connection.addRequestProperty("User-Agent", "DiscordWebhook-Arianna");
        connection.addRequestProperty("X-RateLimit-Scope", "shared");
        connection.addRequestProperty("X-RateLimit-Limit", "10000");
